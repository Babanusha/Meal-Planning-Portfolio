...
import static redacted.path.module.ApplicationSettings.DEFAULT_COST;
import static redacted.path.module.ApplicationSettings.DEFAULT_EXPIRATION_DATE;
...
import static redacted.path.module.ApplicationSettings.STRING_DECIMALFORMAT;
import static redacted.path.module.ApplicationSettings.SWITCH_CASE_LIMIT;

import redacted.path.module.Item;
import redacted.path.module.Fridge;
import redacted.path.view.Reader;
import redacted.path.view.Printer;
import redacted.path.view.UserInterface;
