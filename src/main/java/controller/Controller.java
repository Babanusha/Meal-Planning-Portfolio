...
import static redacted.path.settings.ApplicationSettings.DEFAULT_COST;
import static redacted.path.settings.ApplicationSettings.DEFAULT_EXPIRATION_DATE;
...
import static redacted.path.settings.ApplicationSettings.STRING_DECIMALFORMAT;
import static redacted.path.settings.ApplicationSettings.SWITCH_CASE_LIMIT;
...
public class Controller {
  ...
  private redacted.path.userInterface.userInterface userInterface;
